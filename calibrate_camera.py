...
Examples:
  ...
  python calibrate_camera.py --input "calib_images/*.jpg" --pattern 9x6

  # Stereo camera calibration
  python calibrate_camera.py --stereo \\
      --left "calib_stereo/left/*.jpg" \\
      --right "calib_stereo/right/*.jpg" \\
      --pattern 9x6

  # With custom square size (in mm)
  python calibrate_camera.py --input "calib/*.jpg" --pattern 9x6 --square-size 40
        """
    )
